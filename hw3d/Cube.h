...
{
public:
	//Templated on V so any vertex type struct can be output as long as it 
	//contains .pos member
	template<class V>
	...
	//Make skinned version w/ hard edges (multiple vertices on same pos where they point at diff angles)
	template<class V>
